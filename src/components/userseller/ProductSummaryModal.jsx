...
// import { X, CheckCircle, Image as ImageIcon, Sparkles, Edit3, HelpCircle, AlertCircle, MapPin, ChevronRight, Layers } from "lucide-react";
...
//     // 💡 หาชื่อหมวดหมู่จริงจาก categories ด้วย categoryId
...
//       // console.log(formData.categoryId,categories,categoryName)
//       if (foundCategory) {
...
//   }, [formData, answers, aiResult, isOpen, categoryName, categories]);
...
//   // เลือกหมวดหมู่ใหม่จาก Modal
//   const handleSelectCategoryInModal = (category) => {
//     const catName = category?.name || category?.title || "";
//     const catId = Number(category?.id || category);
    
//     setSelectedCategoryName(catName);
    
//     // อัปเดต formData ในหน้าแม่
//     const updatedForm = { ...editForm, categoryId: catId };
//     setEditForm(updatedForm);
//     onUpdateFormData(updatedForm);
    
//     // ล้างคำตอบสภาพสินค้าเดิมเนื่องจากเปลี่ยนหมวดหมู่
//     setEditAnswers({});
//     onUpdateAnswers({});
...
//                   >
//                     <span className={selectedCategoryName ? "text-base-content font-bold" : "text-base-content/50"}>
//                       {/* 💡 แสดงชื่อหมวดหมู่ที่เลือกจริงๆ */}
//                       {selectedCategoryName || "เลือกหมวดหมู่..."}
//                     </span>
...
//         selectedCategoryId={editForm.categoryId}
//         onSelectCategory={handleSelectCategoryInModal}
//       />
//     </>
//   );
// }
