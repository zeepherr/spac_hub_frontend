...
function ActionItemCard({ order, onConfirm }) {
  const needsPayment =
    order.actionType === "PAYMENT";

  const delivered =
    order.actionType === "CONFIRM_DELIVERY";
  ...
  return (
    <article className="rounded-2xl border border-neutral-200 bg-white p-4 transition hover:border-orange-200 hover:shadow-sm">
