...
import AdminStartSupportDialog from "../AdminStartSupportDialog";
import {
  DetailCard,
  EmptyValue,
  InfoSection,
    ...
    <>
      ...
      >
        ...
        >
          ...
          <footer className="flex shrink-0 flex-col-reverse gap-2 border-t border-neutral-200 bg-neutral-50 px-3 py-3 sm:flex-row sm:justify-end sm:px-6 sm:py-4">
            <button
              type="button"
              onClick={() => setIsSupportOpen(true)}
              className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-orange-500 px-5 text-sm font-bold text-white hover:bg-orange-600"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="h-11 rounded-xl bg-neutral-900 px-5 text-sm font-bold text-white"
            >
              Close
            </button>
          </footer>
