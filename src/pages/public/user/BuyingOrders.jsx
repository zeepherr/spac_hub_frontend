        ...
        <section className="min-h-full bg-neutral-50 px-5 py-8 lg:px-10">
            <div className="mx-auto max-w-6xl">
                <header className="mb-7">
                    <h1 className="text-3xl font-bold text-neutral-900">คำสั่งซื้อของฉัน</h1>
    ...
    return (
        ...
        >
            ...
            <div className="min-w-0 flex-1">
                ...
                <h2 className="mt-1 truncate font-semibold text-neutral-900">{productName}</h2>

                <p className="mt-1 text-sm text-neutral-500">สั่งซื้อเมื่อ {createdAt}</p>
            </div>
...
function EmptyOrders() {
    return (
        <div className="flex min-h-80 flex-col items-center justify-center rounded-2xl border border-neutral-200 bg-white p-8 text-center">
            ...
            <h2 className="mt-4 text-lg font-bold text-neutral-900">ยังไม่มีคำสั่งซื้อ</h2>

            <p className="mt-2 text-sm text-neutral-500">เมื่อซื้อสินค้า คำสั่งซื้อจะแสดงที่หน้านี้</p>
        </div>
    );
}
